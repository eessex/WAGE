    ...
    if ( !this.state.editMode ) {
       payment_row = (
        <tr key={this.state.artist_payment.id}>
          ...
          <td><div className="notes">{this.state.artist_payment.notes}</div></td>
          <td className="last">
            <button onClick={this.setEditMode} className="btn btn-sm">Edit</button>
            <button onClick={this.handleDeleteArtistPayment} className="btn btn-sm btn-danger"><i className="fa fa-trash"></i></button>
          </td>
       </tr>
     );
    } else {
      payment_row = (
           <tr key={this.state.artist_payment.id}>
             ...
             <td className="last">
               <button onClick={this.handleArtistPaymentUpdate} className="btn btn-sm">Save</button>
             </td>
          </tr>
        )
      }
