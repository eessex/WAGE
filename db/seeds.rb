...
fee_cat_12 = FeeCategory.create(name: "Existing Text for Publication", description: "The reprinting of an existing text in a publication issued by an organization.", floor_fee: 50, fee_subtitle: " or $0.025/word", over500K:"0.075")
