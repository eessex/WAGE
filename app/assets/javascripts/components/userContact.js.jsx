    ...
    if ( this.state.editMode ) {
      markup = (
        <div id="contact" className="edit">
          ...
          <div className="rep col-sm-12 col-lg-4">
            {contact_form}
          </div>
          <div className="address col-sm-12 col-lg-6">
            {address_form}
          </div>
        </div>
      );
      ...
      markup = (
        <div className="view">
          ...
          <div className="rep col-sm-12 col-lg-5">
            <div>{this.state.user.rep_name}</div>
            <div>{this.state.user.rep_title}</div>
            <div>{this.state.user.email}</div>
            <div>{this.state.user.phone}</div>
          </div>
          <div className="address col-sm-12 col-lg-5">
            <h3>Mailing Address</h3>
            <div>{this.state.user.address_st1}{displayStreet}</div>
            <div>{this.state.user.address_city}, {this.state.user.address_state} {this.state.user.address_zip}</div>
          </div>
        </div>
      );
    }
