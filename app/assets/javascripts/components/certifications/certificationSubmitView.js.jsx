var CertificationSubmitView = React.createClass({
  ...
  render() {
    ...
    if (this.props.isFuture) {
      ...
      var artist_payments = <div className="section artist-payments clearfix">
        <h3>Artist Payments</h3>
        <h4>Organizations must demonstrate having paid artist fees according to W.A.G.E.’s <a href="/fee-schedule">minimum standards of compensation</a> during the fiscal year.</h4>
        <h4>After submission, <span>this application is considered pending</span> until the close of the fiscal period, when a history of fee payments is required.</h4>
      </div>
    }
